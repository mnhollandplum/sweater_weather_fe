...
searchBtn.addEventListener("click", function() {
  ...
  forecastRequest.open('GET', 'https://sweater-weather-be.herokuapp.com/api/v1/forecast?location=' + location)
...
addFavoriteBtn.addEventListener("click", function() {
  ...
  addFavorite.open('POST', 'https://sweater-weather-be.herokuapp.com/api/v1/favorites?location=' + location + '&api_key=12992528-bc65-4b79-9bdf-ba314c6c7dea')
  addFavorite.onload = function() {
  };
  addFavorite.send()
  alert(location.toUpperCase() + " has been added to your favorites!")
});
...
favoritesRequest.open('GET', 'https://sweater-weather-be.herokuapp.com/api/v1/favorites?api_key=12992528-bc65-4b79-9bdf-ba314c6c7dea')
...
function displayDailyForecast(data) {
  ...
  var nextDay = data["daily"]["data"][1];
    document.getElementById("next-day").innerHTML = new Date (nextDay["time"]*1000).getDate() + ":" + "  Summary: " + nextDay["summary"] + "  Precipitation: " + nextDay["precipProbability"]+ "%" + "  Max temp: " + nextDay["temperatureMax"] + '&deg' + "  Min temp: " + nextDay["temperatureMin"] + '&deg'

  var thirdDay = data["daily"]["data"][2];
    document.getElementById("third-day").innerHTML = new Date (thirdDay["time"]*1000).getDate() + ":" + "  Summary: " + thirdDay["summary"] + "  Precipitation: " + thirdDay["precipProbability"]+ "%" + "  Max temp: " + thirdDay["temperatureMax"] + '&deg' + "  Min temp: " + thirdDay["temperatureMin"] + '&deg'

  var fourthDay = data["daily"]["data"][3];
    document.getElementById("fourth-day").innerHTML = new Date (fourthDay["time"]*1000).getDate() + ":" + "  Summary: " + fourthDay["summary"] + "  Precipitation: " + fourthDay["precipProbability"]+ "%" + "  Max temp: " + fourthDay["temperatureMax"] + '&deg' + "  Min temp: " + fourthDay["temperatureMin"] + '&deg'

  var fifthDay = data["daily"]["data"][4];
    document.getElementById("fifth-day").innerHTML = new Date (fifthDay["time"]*1000).getDate() + ":" + "  Summary: " + fifthDay["summary"] + "  Precipitation: " + fifthDay["precipProbability"]+ "%" + "  Max temp: " + fifthDay["temperatureMax"] + '&deg' + "  Min temp: " + fifthDay["temperatureMin"] + '&deg'

  var sixthDay = data["daily"]["data"][5];
    document.getElementById("sixth-day").innerHTML = new Date (sixthDay["time"] *1000).getDate() + ":" + "  Summary: " + sixthDay["summary"] + "  Precipitation: " + sixthDay ["precipProbability"] + "%" + "  Max temp: " + sixthDay["temperatureMax"] + '&deg' + "  Min temp: " + sixthDay["temperatureMin"] + '&deg'
}

function displayFavorites(data) {
  console.log(data["data"][0])
  var favoriteTitle = "Favorite Locations"
    document.getElementById("current-title").innerHTML = favoriteTitle

    var favOne = data["data"][0]["attributes"]["location"];
      document.getElementById("favorite-loc-1").innerHTML = favOne

    var favTwo = data["data"][1]["attributes"]["location"];
      document.getElementById("favorite-loc-2").innerHTML = favTwo

    var favThree = data["data"][2]["attributes"]["location"];
      document.getElementById("favorite-loc-3").innerHTML = favThree
}
