...
addFavoriteBtn.addEventListener("click", function() {
  ...
  addFavorite.open('POST', 'http://sweater-weather-be.herokuapp.com/api/v1/favorites?location=' + location + '&api_key=12992528-bc65-4b79-9bdf-ba314c6c7dea')
  addFavorite.onload = function() {
  };
  addFavorite.send()
  alert(location + "This location has been added to your favorites!")
});
...
favoritesRequest.open('GET', 'http://sweater-weather-be.herokuapp.com/api/v1/favorites?&api_key=12992528-bc65-4b79-9bdf-ba314c6c7dea')
